...
- Optional live Google Maps reviews on the homepage. These retain Google's attribution and relevance order and do not add rating structured data. See [Google reviews setup](./GOOGLE-REVIEWS.md).
